...
canvas.create_text(8.0,45.0,anchor="nw",text="Para ingresar sin, cos, tg o √ (sqrt) ",fill="#FFFFFF",font=("Roboto", 12 * -1))
canvas.create_text(8.0,59.0,anchor="nw",text="debera anteponer las letras np. mas la ",fill="#FFFFFF",font=("Roboto", 12 * -1))
canvas.create_text(8.0,73.0,anchor="nw",text="operación Ejemplo:",fill="#FFFFFF",font=("Roboto", 12 * -1))
canvas.create_text(8.0,87.0,anchor="nw",text="np.sin(x)  ,  0.1*np.sqrt(x)+(0.4*t)**2",fill="#FFFFFF",font=("Roboto", 12 * -1))
